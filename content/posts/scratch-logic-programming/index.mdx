...
date: 2020-04-04
slug: "/course/scratch-logic-programming"
description: "     O Scratch é uma ferramenta interessante para aqueles que desejam aprender a programar.
...
> E ai vamos vamos aprender lógica computacional?
...
- Versão 2.0: Mode para 2 jogadores
    - Duplicando da maça
    - Modificando o Código da maça 2
    - Duplicando o gato laranja
    - Modificando o Código para gato azul
...
|----------|:-------------:|------:|
| à definir |  Executando o Scratch | - |
| à definir |  Editor Scratch Nativo | - |
